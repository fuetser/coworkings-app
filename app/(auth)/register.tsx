...
export default function Register() {
  ...
  const handleRegister = async () => {
    ...
    setAuthError("");
    const { isValid, trimmedName, trimmedEmail, trimmedPhone } =
      validateForm();
  ...
  return (
    ...
    >
      <View style={styles.welcomeContainer}>
        <Text style={styles.welcomeTitle}>{t("auth.register.title")}</Text>
        ...
        >
          {isSubmitting ? (
            <View style={styles.loadingContent}>
              ...
              <Text style={styles.primaryButtonText}>{t("auth.register.submitting")}</Text>
            </View>
          ) : (
